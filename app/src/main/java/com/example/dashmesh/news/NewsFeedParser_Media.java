...
public class NewsFeedParser_Media {
    ...
    public NewsFeedParser_Media(String urlString) {
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (tagName.equals(CHANNEL)) {
                            ...
                            rssFeed = new RSSFeed(title,link,description,category,pubDate,guid,feedburner,url,description_1);
